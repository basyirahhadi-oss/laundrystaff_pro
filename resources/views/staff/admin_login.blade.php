    ...
    <main class="flex-1 flex items-center justify-center px-4 sm:px-6 py-10 relative z-10">
        <div class="max-w-md w-full">
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('kiosk.scan') }}" class="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-400 hover:text-white transition">
