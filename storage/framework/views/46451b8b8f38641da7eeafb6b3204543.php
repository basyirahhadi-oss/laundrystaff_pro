...
<body class="bg-slate-900 text-slate-100 min-h-screen flex flex-col antialiased selection:bg-indigo-500 selection:text-white">
    ...
    <header class="bg-slate-900/90 backdrop-blur-md border-b border-slate-800 sticky top-0 z-50">
        <div class="max-w-5xl mx-auto px-6 py-3.5 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('images/zaujati-logo.png')); ?>" alt="Zaujati Laundry" class="w-10 h-10 rounded-xl object-contain bg-slate-950 p-1 border border-slate-800 shadow-md">
                <div>
            ...
            <a href="<?php echo e(route('kiosk.gateway')); ?>" class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl text-xs font-bold bg-slate-800 hover:bg-slate-700 text-slate-300 transition border border-slate-700/80">
            ...
            <div class="lg:col-span-5 space-y-4">
                <div class="bg-slate-950 rounded-3xl border border-slate-800/80 p-6 shadow-2xl">
                    ...
                    <form action="<?php echo e(route('kiosk.confirm')); ?>" method="POST">
                        ...
                        <input type="hidden" name="kiosk_token" id="kiosk_token" value="<?php echo e($kioskToken ?? ''); ?>">
    ...
    <script>
        ...
        const STAFF_LIST = <?php echo json_encode($staffList, 15, 512) ?>;
...
</html><?php /**PATH C:\laragon\www\laundrystaff-pro\resources\views/staff/scan.blade.php ENDPATH**/ ?>