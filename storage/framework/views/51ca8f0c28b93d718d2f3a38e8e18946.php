    ...
    <header class="bg-slate-900/90 backdrop-blur-md border-b border-slate-800 sticky top-0 z-50">
        <div class="max-w-4xl mx-auto px-6 py-3.5 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('images/zaujati-logo.png')); ?>" alt="Zaujati Laundry" class="w-9 h-9 rounded-xl object-contain bg-slate-950 p-1 border border-slate-800 shadow-md">
                <div>
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl text-xs font-bold bg-slate-800 hover:bg-slate-700 text-slate-300 transition border border-slate-700/80">
    ...
    <main class="flex-1 flex items-center justify-center px-6 py-12 relative z-10">
        <div class="max-w-md w-full text-center space-y-6">
            ...
            <div class="space-y-3">
                ...
                <a href="<?php echo e(route('kiosk.scan')); ?>"
                ...
                <a href="<?php echo e(route('kiosk.admin-login')); ?>"
...
</html><?php /**PATH C:\laragon\www\laundrystaff-pro\resources\views/staff/attendance_gateway.blade.php ENDPATH**/ ?>