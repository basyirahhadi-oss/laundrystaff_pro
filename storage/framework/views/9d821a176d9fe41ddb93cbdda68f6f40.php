    ...
    <div class="py-8 bg-slate-50 min-h-screen">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 p-8 shadow-sm">
                ...
                <form action="<?php echo e(route('staff.leaves.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select name="leave_type" required
                            ...
                            <option value="annual" <?php echo e(old('leave_type') === 'annual' ? 'selected' : ''); ?>>Annual Leave (Cuti Tahunan)</option>
                            <option value="mc" <?php echo e(old('leave_type') === 'mc' ? 'selected' : ''); ?>>Medical Leave (Cuti Sakit / MC)</option>
                            <option value="emergency" <?php echo e(old('leave_type') === 'emergency' ? 'selected' : ''); ?>>Emergency Leave (Cuti Kecemasan)</option>
                            <option value="unpaid" <?php echo e(old('leave_type') === 'unpaid' ? 'selected' : ''); ?>>Unpaid Leave (Cuti Tanpa Gaji)</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="reason" rows="3" required
                            ...
                            class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs font-medium text-slate-800 focus:bg-white focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition"><?php echo e(old('reason')); ?></textarea>
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\laundrystaff-pro\resources\views/staff/leaves/create.blade.php ENDPATH**/ ?>