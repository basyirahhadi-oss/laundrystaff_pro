     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2.5">
                <form method="GET" action="<?php echo e(route('staff.payroll.index')); ?>" class="flex items-center gap-2">
                    ...
                    <select name="year" id="year" onchange="this.form.submit()"
                        ...
                        <option value="all" <?php echo e($selectedYear === 'all' ? 'selected' : ''); ?>>All Years</option>
                        <?php $__currentLoopData = $availableYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yearOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($yearOption); ?>" <?php echo e((string)$selectedYear === (string)$yearOption ? 'selected' : ''); ?>>
                ...
                <?php if($latestPayroll): ?>
                    <a href="<?php echo e(route('staff.payroll.print', $latestPayroll->id)); ?>" target="_blank"
                ...
                <div class="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div class="flex items-center gap-3.5">
                        <div class="w-12 h-12 rounded-2xl bg-slate-900 border border-slate-800 text-white flex items-center justify-center font-bold text-base uppercase shrink-0 shadow-xs">
                            <?php if(!empty($staffProfile->profile_picture)): ?>
                                <img src="<?php echo e(asset('uploads/staff/' . $staffProfile->profile_picture)); ?>" 
                                     alt="<?php echo e($staffProfile->full_name); ?>" 
                                     class="w-full h-full object-cover rounded-2xl">
                            <?php else: ?>
                                <?php echo e(substr($staffProfile->full_name, 0, 2)); ?>

                            <?php endif; ?>
                        </div>
                        <div>
                            <div class="flex items-center gap-2">
                                <h2 class="text-base font-bold text-slate-900 tracking-tight"><?php echo e($staffProfile->full_name); ?></h2>
                                <span class="px-2 py-0.5 rounded-md text-[11px] font-bold bg-slate-100 text-slate-700 font-mono">
                                    <?php echo e($staffProfile->staff_id); ?>

                                </span>
                            </div>
                            <p class="text-xs text-slate-500 font-medium mt-0.5">
                                Position: <span class="text-slate-800 font-semibold"><?php echo e($staffProfile->position); ?></span>
                                <?php if(!empty($staffProfile->phone_number)): ?>
                                    · Phone: <span class="text-slate-600 font-mono-nums"><?php echo e($staffProfile->phone_number); ?></span>
                                <?php endif; ?>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4 bg-slate-50 border border-slate-200/60 rounded-xl px-4 py-3 self-stretch md:self-auto justify-between md:justify-end">
                        <div>
                            ...
                            <span class="text-base sm:text-lg font-bold text-slate-900 font-mono-nums">
                                RM <?php echo e(number_format($staffProfile->salary_rate, 2)); ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs">
                        ...
                        <div class="text-2xl font-black text-slate-900 font-mono-nums tracking-tight">
                            <?php if($latestPayroll): ?>
                                RM <?php echo e(number_format($latestPayroll->net_salary, 2)); ?>
                        ...
                        <div class="flex items-center gap-1.5 mt-1.5">
                            ...
                            <p class="text-xs font-medium text-slate-500">
                                <?php echo e($latestPayroll ? $latestPayroll->month_year : 'No records processed'); ?>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs">
                        ...
                        <div class="text-2xl font-black text-slate-900 font-mono-nums tracking-tight">
                            RM <?php echo e(number_format($totalNetYtd, 2)); ?>

                        </div>
                        <p class="text-xs font-medium text-slate-500 mt-1.5">
                            Across <?php echo e($payrolls->count()); ?> payment cycles
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs">
                        ...
                        <div class="text-2xl font-black text-emerald-600 font-mono-nums tracking-tight">
                            +RM <?php echo e(number_format($totalOtYtd, 2)); ?>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs">
                        ...
                        <div class="text-2xl font-black text-slate-800 font-mono-nums tracking-tight">
                            RM <?php echo e(number_format($totalStatutoryYtd, 2)); ?>
                    ...
                    <div class="px-6 py-4 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white">
                        ...
                        <div class="flex items-center gap-2">
                            <span class="text-xs font-bold px-3 py-1 rounded-full bg-slate-100 text-slate-700 font-mono-nums">
                                <?php echo e($payrolls->count()); ?> Payslips Issued
                            </span>
                        </div>
                    </div>
                                    ...
                                    <tr class="hover:bg-slate-50/60 transition-colors">
                                        <td class="px-6 py-4">
                                            ...
                                            <span class="block text-[10px] text-slate-400 mt-1 font-mono-nums">
                                                Issued: <?php echo e(date('d M Y', strtotime($p->created_at))); ?>
                                        ...
                                        <td class="px-6 py-4 font-mono-nums">
                                            <?php if($p->ot_hours > 0): ?>
                                                <span class="text-emerald-600 font-bold">+RM <?php echo e(number_format($p->ot_pay, 2)); ?></span>
                                                <span class="text-[10px] text-slate-400 block font-sans">(<?php echo e($p->ot_hours); ?> hrs)</span>
                                            <?php else: ?>
                                        ...
                                        <td class="px-6 py-4 font-mono-nums text-rose-600 font-medium">
                                            -RM <?php echo e(number_format($p->socso_deduction, 2)); ?>

                                        </td>
                                        <td class="px-6 py-4 font-mono-nums text-rose-600 font-medium">
                                            -RM <?php echo e(number_format($p->eis_deduction, 2)); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\laundrystaff-pro\resources\views/staff/payroll/index.blade.php ENDPATH**/ ?>