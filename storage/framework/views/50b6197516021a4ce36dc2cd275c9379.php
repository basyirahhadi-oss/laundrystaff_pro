...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="h-full bg-slate-50">
    <head>
        ...
        <title><?php echo e(config('app.name', 'LaundryStaff Pro')); ?> · Enterprise HRMS &amp; Operations</title>
...
</html><?php /**PATH C:\laragon\www\laundrystaff-pro\resources\views/layouts/app.blade.php ENDPATH**/ ?>