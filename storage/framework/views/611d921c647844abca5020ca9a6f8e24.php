                ...
                <div class="lg:col-span-5 space-y-6">
                    <div class="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-sm">
                        <div class="flex items-center gap-3 pb-4 mb-4 border-b border-slate-100">
                            ...
                            <div>
                                <h3 class="text-sm font-bold text-slate-900"><?php echo e($staff->full_name); ?></h3>
                                <p class="text-[11px] text-slate-400"><?php echo e($staff->staff_id); ?> · <?php echo e($staff->position); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="bg-slate-50 rounded-xl p-4 border border-slate-200/70 mb-5 flex items-center justify-between">
                            <div>
                                ...
                                <span class="text-lg font-bold text-slate-900">RM <?php echo e(number_format($staff->salary_rate, 2)); ?></span>
                                <input type="hidden" id="base_salary" value="<?php echo e($staff->salary_rate); ?>">
                            </div>
                        ...
                        <form action="<?php echo e(route('staff.payroll.store', $staff->staff_id)); ?>" method="POST" class="space-y-4">
                            <?php echo csrf_field(); ?>
                                ...
                                <div>
                                    ...
                                    <select name="month" id="select_month" required
                                        ...
                                        <?php $__currentLoopData = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($m); ?>" <?php echo e(date('F') == $m ? 'selected' : ''); ?>><?php echo e($m); ?></option>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200/80 p-8 shadow-sm">
                        ...
                        <div class="flex items-start justify-between border-b border-slate-100 pb-5 mb-5">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-xs font-semibold text-slate-800 mt-1" id="payslip_date"><?php echo e(date('F')); ?> 2026</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-slate-50 rounded-xl p-4 border border-slate-200/60 mb-6 grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs">
                            <div>
                                ...
                                <span class="font-semibold text-slate-800 text-xs"><?php echo e($staff->full_name); ?></span>
                            </div>
                            <div>
                                <span class="text-[10px] font-semibold uppercase tracking-wider text-slate-400 block">Employee Code</span>
                                <span class="font-semibold text-indigo-700"><?php echo e($staff->staff_id); ?></span>
                            </div>
                            <div>
                                <span class="text-[10px] font-semibold uppercase tracking-wider text-slate-400 block">Position</span>
                                <span class="font-medium text-slate-700"><?php echo e($staff->position); ?></span>
                            </div>
                        </div>
                            ...
                            <table class="w-full text-xs text-left">
                                ...
                                <tbody class="divide-y divide-slate-100">
                                    <tr>
                                        ...
                                        <td class="px-5 py-3 text-right font-semibold text-slate-900">RM <?php echo e(number_format($staff->salary_rate, 2)); ?></td>
                                    </tr>
                                    ...
                                    <tr class="bg-indigo-50/80 border-t-2 border-indigo-200">
                                        ...
                                        <td class="px-5 py-4 text-right font-bold text-xl text-indigo-900" id="display_net_salary">
                                            RM <?php echo e(number_format($staff->salary_rate, 2)); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\laundrystaff-pro\resources\views/staff/payroll.blade.php ENDPATH**/ ?>